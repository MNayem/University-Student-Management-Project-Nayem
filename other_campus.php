...
<html>
	<head>
		...
		<title>other campus of NWU</title>
	</head>
	<body onload="startTime()">
		...
		<div class="main">
			<div class="banner">
					...
					<a href="other_campus.php"><img src="images/NWU.jpg" alt=""></img></a>
			</div>
			<div class="mainmenu">
				<ul class="menu">
					<ul>
			...
			<div class="about">
				...
				<div class="right_side">
					<h2>BBA Campus of North Western University,KHULNA</h2>
					<br>
					<h3>236 M.A Bari Road, Sonadanga, Khulna-9100</h3>
					<br>
					<div class="library_pic">
						<img src="images/bld1.jpg"></img>
					</div>
				</div>
			</div>
		</div>
