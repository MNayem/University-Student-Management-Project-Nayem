...
<html>
	<head>
		...
		<title>office of department head</title>
	</head>
	<body onload="startTime()">
		...
		<div class="main">
			<div class="banner">
					...
					<a href="dept_head_office.php"><img src="images/NWU.jpg" alt=""></img></a>
			</div>
			<div class="mainmenu">
				<ul class="menu">
					<ul>
			...
			<div class="about">
				...
				<div class="right_side">
					<h2>Office of Department Head</h2>
					<br>
					<div class="right_area">
						<div class="image">
							<img src="images/bld2.jpg"></img>
						</div>
						<h3><p><a href="">#Building : 02</a></p></h3>
						<br>
						<h3><p><a href="">#Room : 701</a></p></h3>
						<br>
						<h3><p><a href="">#Contact : +8801957254326</a></p></h3>
						<br>
						<h3><p><a href="">#Email : deptheadofcse@gmail.com</a></p></h3>
					</div>
				</div>
			</div>
		</div>
