	...
	<body onload="startTime()">
		...
		<div class="main">
			<div class="banner">
					...
					<a href="verification.php"><img src="images/NWU.jpg" alt=""></img></a>
			</div>
			<div class="mainmenu">
				<ul class="menu">
					<ul>
			...
			<div class="about">
				...
				<div class="right_side">
					<h2>Online Verification and Data Entry Process</h2>
					<br>
					<p>It is hereby notified for the information of the students admitted in different Departments 
					   of North Western University that for uploading students information from the website of the 
					   University, students will have to collect and fill in the "ONLINE VERIFICATION DATA ENTRY FORM". 
					   Intending students may obtain prescribed forms from the Accounts section (ground floor, Building No. 01)
