...
<html>
	<head>
		...
		<title>laboratories facilities of CSE</title>
	</head>
	<body onload="startTime()">
		...
		<div class="main">
			<div class="banner">
					...
					<a href="lab.php"><img src="images/NWU.jpg" alt=""></img></a>
			</div>
			<div class="mainmenu">
				<ul class="menu">
					<ul>
			...
			<div class="about">
				...
				<div class="right_side">
					<h2>Laboratories Facilities of CSE discipline of NWU</h2>
					<br>
						<h3><p><a href="">Computer Laboratories</a></p></h3>
						<br>
						<h3><p><a href="">Software Laboratories</a></p></h3>
						<br>
						<h3><p><a href="">Hardware Laboratories</a></p></h3>
						<br>
						<h3><p><a href="">Computer Workshop Laboratories</a></p></h3>
						<br>
						<h3><p><a href="">Thesis Work Laboratories</a></p></h3>
						<br>
						<h3><p><a href="">Well Decorated Special Laboratories</a></p></h3>
						<br>
				</div>
			</div>
		</div>
