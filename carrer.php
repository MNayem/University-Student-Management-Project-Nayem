	...
	<body onload="startTime()">
		...
		<div class="main">
			<div class="banner">
					...
					<a href="carrer.php"><img src="images/NWU.jpg" alt=""></img></a>
			</div>
			<div class="mainmenu">
				<ul class="menu">
					<ul>
			...
			<div class="about">
				...
				<div class="right_side">
					<h2>Vacancy Announcement for CSE Department of NWU</h2>
					<br>
					<p>North Western University,Khulna.The First Prvate University in Khulna.Committed to world class education.Computer Science and Engineering</p>
				</div>
			</div>
		</div>
		<div class="footer">
