	...
	<body onload="startTime()">
		...
		<div class="main">
			<div class="banner">
					...
					<a href="facility.php"><img src="images/NWU.jpg" alt=""></img></a>
			</div>
			<div class="mainmenu">
				<ul class="menu">
					<ul>
			...
			<div class="about">
				...
				<div class="right_side">
					<h2>Facilities of CSE discipline of NWU</h2>
					<br>
						<p>Well equipped Laboratories</p>
						<br>
						<p>Rich Library</p>
						<br>
						<p>Modern Computer Labs and Internet Access</p>
						<br>
						<p>Workshop Based Teaching by full-time teachers (NWU) & Adjunt Faculties from public Universities</p>
						<br>
						<p>Power point and Multimedia Presentation</p>
						<br>
						<p>Scholarships facilities for Meritorious & Female Students</p>
						<br>
						<p>Convenient Class Schedule fro Professionals</p>
						<br>
						<p>Credit Transfer Facilities where possible</p>
						<br>
						<p>Well furnished air-conditioned class rooms</p>
						<br>
				</div>
			</div>
		</div>
