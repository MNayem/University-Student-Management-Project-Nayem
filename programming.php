...
<html>
	<head>
		...
		<title>programming contest of CSE department</title>
	</head>
	<body onload="startTime()">
		...
		<div class="main">
			<div class="banner">
					...
					<a href="programming.php"><img src="images/NWU.jpg" alt=""></img></a>
			</div>
			<div class="mainmenu">
				<ul class="menu">
					<ul>
			...
			<div class="about">
				...
				<div class="right_side">
					<h2>Programming Contest of CSE Department</h2>
					<br>
					<p><b>Programming contest'16</b></p>
					<br>
					<div class="library_pic">
						<img src="images/programming1.jpg"></img>
					</div>
					<br>
					<p><b>Programming contest'16</b></p>
					<br>
