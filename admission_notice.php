	...
	<body onload="startTime()">
		...
		<div class="main">
			<div class="banner">
					...
					<a href="admission_notice.php"><img src="images/NWU.jpg" alt=""></img></a>
			</div>
			<div class="mainmenu">
				<ul class="menu">
					<ul>
			...
			<div class="about">
				...
				<div class="right_side">
					...
					<br></br>
					<p>Admission forms are available at the Admission office.</p>
					<br>
					<p><a href="">Download Admission form</a></p>	
					<br>
					<P><h4><b> The following papers need to be submitted for admission in North Western University</b></h4></P>
					<br>
					<p> 1. All Original academic Transcripts.</P>
					<br>
					<p> 2. Two Attested copies of all academic Transcripts & Certificates/Testimonials.</p>
					<br>
					<p> 3. Five copies of colored passport size recent photograph (with formal dress).</p>
					<br>
					<p> 4.  Experience Certificates for all Relevant Programs</p>
					<br><br>
				</div>
			</div>
		</div>
