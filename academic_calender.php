...
<html>
	<head>
		...
		<title>academic calender for CSE department of NWU</title>
	</head>
	<body onload="startTime()">
		...
		<div class="main">
			<div class="banner">
					...
					<a href="academic_calender.php"><img src="images/NWU.jpg" alt=""></img></a>
			</div>
			<div class="mainmenu">
				<ul class="menu">
					<ul>
			...
			<div class="about">
				...
				<div class="right_side">
					<h2>Academic Calender For CSE Department of NWU,KHULNA</h2>
					<br>
