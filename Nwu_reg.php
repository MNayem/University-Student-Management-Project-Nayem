...
<html>
	<head>
		...
		<title>registration process of NWU</title>
	</head>
	<body onload="startTime()">
		...
		<div class="main">
			<div class="banner">
					...
					<a href="Nwu_reg.php"><img src="images/NWU.jpg" alt=""></img></a>
			</div>
			<div class="mainmenu">
				<ul class="menu">
					<ul>
			...
			<div class="about">
				...
				<div class="right_side">
					<h2>NWU STUDENT'S REGISTRATION PROCESS</h2>
					<br>
					<p><b>Please visit : <a href="http://www.nwu.edu.bd">www.nwu.edu.bd</a></b></p>
					<div class="library_pic">
						<img src="images/registration-process.jpg"></img>
					</div>
					<br>
				</div>
			</div>
