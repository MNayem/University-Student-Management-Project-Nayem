...
<html>
	<head>
		...
		<title>registration dateline for summer'16</title>
	</head>
	<body onload="startTime()">
		...
		<div class="main">
			<div class="banner">
					...
					<a href="dateline.php"><img src="images/NWU.jpg" alt=""></img></a>
			</div>
			<div class="mainmenu">
				<ul class="menu">
					<ul>
			...
			<div class="about">
				...
				<div class="right_side">
					<h2>Course Registration Dateline For Summer'16</h2>
					<br>
					<p>Students in general were asked through earlier notifications to complete their Course 
					   Registration for the Semester Summer-2016 within 04/05/2016 by paying at least one-third 
					   of their Semester fees. But it appears from University records that many of the students 
					   have not yet completed their Course Registration by paying their Semester fees. Students are, 
					   therefore, reminded that they must complete their Course Registration for Summer Semester-2016 
					   within 08 June, 2016 by paying at least one third of their Semester Fee, otherwise a fine of 
					   TK 500/= (Taka five hundred) will be charged from the students concerned for Course Registration 
					   after this date.</p>
					<br>
				</div>
			</div>
