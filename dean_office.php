	...
	<body onload="startTime()">
		...
		<div class="main">
			<div class="banner">
					...
					<a href="dean_office.php"><img src="images/NWU.jpg" alt=""></img></a>
			</div>
			<div class="mainmenu">
				<ul class="menu">
					<ul>
			...
			<div class="about">
				...
				<div class="right_side">
					...
					<div class="right_area">
						...
						<br>
						<h3><p><a href="">#Room : 305</a></p></h3>
						<br>
						<h3><p><a href="">#Contact : +8801957254326</a></p></h3>
						<br>
						<h3><p><a href="">#Email : dean@gmail.com</a></p></h3>
					</div>
				</div>
			</div>
		</div>
