...
<html>
	<head>
		...
		<title>all graduate program of NWU</title>
	</head>
	<body onload="startTime()">
		...
		<div class="main">
			<div class="banner">
					...
					<a href="graduate.php"><img src="images/NWU.jpg" alt=""></img></a>
			</div>
			<div class="mainmenu">
				<ul class="menu">
					<ul>
			...
			<div class="about">
				...
				<div class="right_side">
					...
					<br>
					<h2> Proposed Graduate Program at NWU with approximate total cost :</h2>
					<table border="5" bgcolor="white" align="center" width="685">
						<tr>
							<td colspan="20" align="center" bgcolor="sky-blue">
								<h1>All Proposed Graduate Program with Cost</h1>
							</td>
						</tr>
						<tr align="center">
							<th>Name of faculties :</th>
