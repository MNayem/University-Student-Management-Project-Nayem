...
<html>
	<head>
		...
		<title>courses of first year</title>
	</head>
	<body onload="startTime()">
		...
		<div class="main">
			<div class="banner">
					...
					<a href="first_year.php"><img src="images/NWU.jpg" alt=""></img></a>
			</div>
			<div class="mainmenu">
				<ul class="menu">
					<ul>
			...
			<div class="about">
				...
				<div class="right_side">
					<h2>All Courses For First Year Students is Here...!!!</h2>
					<br>
					<h3><a href="first_year.php?first_year_first_semester=First Year First Semester">First Year First Semester</a></h3>
					<br>
					<h3><a href="first_year.php?first_year_second_semester=First Year Second Semester">First Year Second Semester</a><h3>
					<br>
					<h3><a href="first_year.php?first_year_third_semester=First Year Third Semester">First Year Third Semester</a><h3>
					<br>
					
					<?php
						include("includes/db1.php");
						
						if(isset($_GET['first_year_first_semester']))
						{
							
					?>
					<table width="680" align="center" border="2">
						<tr>
							<td bgcolor="aqua" colspan="6" align="center"><h3>All courses for first year first semester is here...!!!</h3></td>
						</tr>
						<tr align="center">
							<th>Serial No.</th>
							<th>Subject Code</th>
						...
						<tr>
								<?php
									$subject = $_GET['first_year_first_semester'];
									
									$query = "select *from first_year_first_semester";
					...
					<?php
						...
						if(isset($_GET['first_year_second_semester']))
						{
							
					?>
					<table width="680" align="center" border="2">
						<tr>
							<td bgcolor="aqua" colspan="6" align="center"><h3>All courses for first year second semester is here...!!!</h3></td>
						</tr>
						<tr align="center">
							<th>Serial No.</th>
							<th>Subject Code</th>
						...
						<tr>
								<?php
									$subject1 = $_GET['first_year_second_semester'];
									
									$query1 = "select *from 1st_year_2nd_semester";
					...
					<?php
						...
						if(isset($_GET['first_year_third_semester']))
						{
							
					?>
					<table width="680" align="center" border="2">
						<tr>
							<td bgcolor="aqua" colspan="6" align="center"><h3>All courses for first year third is semester here...!!!</h3></td>
						</tr>
						<tr align="center">
							<th>Serial No.</th>
							<th>Subject Code</th>
						...
						<tr>
								<?php
									$subject2 = $_GET['first_year_third_semester'];
									
									$query2 = "select *from 1st_year_3rd_semester";
