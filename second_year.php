...
<html>
	<head>
		...
		<title>courses of second year</title>
	</head>
	<body onload="startTime()">
		...
		<div class="main">
			<div class="banner">
					...
					<a href="second_year.php"><img src="images/NWU.jpg" alt=""></img></a>
			</div>
			<div class="mainmenu">
				<ul class="menu">
					<ul>
			...
			<div class="about">
				...
				<div class="right_side">
					<h2>All Courses For Second Year Students is Here...!!!</h2>
					<br>
					<h3><a href="second_year.php?second_year_first_semester=Second Year First Semester">Second Year First Semester</a></h3>
					<br>
					<h3><a href="second_year.php?second_year_second_semester=Second Year Second Semester">Second Year Second Semester</a><h3>
					<br>
					<h3><a href="second_year.php?second_year_third_semester=Second Year Third Semester">Second Year Third Semester</a><h3>
					<br>
					
					<?php
						include("includes/db1.php");
						
						if(isset($_GET['second_year_first_semester']))
						{
							
					?>
					<table width="680" align="center" border="2">
						<tr>
							<td bgcolor="aqua" colspan="6" align="center"><h3>All courses for second year first semester is here...!!!</h3></td>
						</tr>
						<tr align="center">
							<th>Serial No.</th>
							<th>Subject Code</th>
						...
						<tr>
								<?php
									$subject = $_GET['second_year_first_semester'];
									
									$query = "select *from 2nd_year_1st_semester";
					...
					<?php
						...
						if(isset($_GET['second_year_second_semester']))
						{
							
					?>
					<table width="680" align="center" border="2">
						<tr>
							<td bgcolor="aqua" colspan="6" align="center"><h3>All courses for second year second semester is here...!!!</h3></td>
						</tr>
						<tr align="center">
							<th>Serial No.</th>
							<th>Subject Code</th>
						...
						<tr>
								<?php
									$subject1 = $_GET['second_year_second_semester'];
									
									$query1 = "select *from 2nd_year_2nd_semester";
					...
					<?php
						...
						if(isset($_GET['second_year_third_semester']))
						{
							
					?>
					<table width="680" align="center" border="2">
						<tr>
							<td bgcolor="aqua" colspan="6" align="center"><h3>All courses for second year third semester is here...!!!</h3></td>
						</tr>
						<tr align="center">
							<th>Serial No.</th>
							<th>Subject Code</th>
						...
						<tr>
								<?php
									$subject2 = $_GET['second_year_third_semester'];
									
									$query2 = "select *from 2nd_year_3rd_semester";
