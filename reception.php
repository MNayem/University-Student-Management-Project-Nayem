...
<html>
	<head>
		...
		<title>reception of the faculty</title>
	</head>
	<body onload="startTime()">
		...
		<div class="main">
			<div class="banner">
					...
					<a href="reception.php"><img src="images/NWU.jpg" alt=""></img></a>
			</div>
			<div class="mainmenu">
				<ul class="menu">
					<ul>
						<li class="submenu"><a href="">About</a>
							<ul class="hidden">
								...
								<li><a href="vision" target="">Vision</a></li>
			...
			<div class="about">
				...
				<div class="right_side">
					...
					<div class="right_area">
						...
						<br>
						<h3><p><a href="">#Room : Front</a></p></h3>
						<br>
						<h3><p><a href="">#Contact : +8801957254326</a></p></h3>
						<br>
						<h3><p><a href="">#Email : reception@gmail.com</a></p></h3>
					</div>
				</div>
			</div>
		</div>
