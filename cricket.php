...
<html>
	<head>
		...
		<title>annual cricket tournament'16</title>
	</head>
	<body onload="startTime()">
		...
		<div class="main">
			<div class="banner">
					...
					<a href="cricket.php"><img src="images/NWU.jpg" alt=""></img></a>
			</div>
			<div class="mainmenu">
				<ul class="menu">
					<ul>
			...
			<div class="about">
				...
				<div class="right_side">
					<h2>Annual Football Tournament of CSE Department</h2>
					<br>
					<p><b>Annual football tournament'16</b></p>
					<br>
					<div class="library_pic">
						<img src="images/cricket.jpg"></img>
					</div>
					<br>
					<p><b>Annual football tournament'16</b></p>
					<br>
