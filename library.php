...
<html>
	<head>
		...
		<title>library of Engineering Faculty</title>
	</head>
	<body onload="startTime()">
		...
		<div class="main">
			<div class="banner">
					...
					<a href="library.php"><img src="images/NWU.jpg" alt=""></img></a>
			</div>
			<div class="mainmenu">
				<ul class="menu">
					<ul>
			...
			<div class="about">
				...
				<div class="right_side">
					<h2>Library For Faculty of Engineering and Technology</h2>
					<br>
						<div class="right_area">
							<div class="image">
								<img src="images/Farkanda Zabi Kulsum.jpg"></img>
						</div>
						<p><a href="">Farkanda Zabi Kulsum</a></p>
						<br>
						<h3><p>#Building : 02</p></h3>
						<br>
						<h3><p>#Room : Top Floor</p></h3>
						<br>
						<h3><p>#Contact : +8801196269076</p></h3>
						<br>
						<h3><p>#Email :farkandazabikulsum@gmail.com</p></h3>
					</div>
					<div class="library_pic">
						<img src="images/library.jpg"></img>
					</div>
				</div>
			</div>
		</div>
