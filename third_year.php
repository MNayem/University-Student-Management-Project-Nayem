...
<html>
	<head>
		...
		<title>courses of third year</title>
	</head>
	<body onload="startTime()">
		...
		<div class="main">
			<div class="banner">
					...
					<a href="third_year.php"><img src="images/NWU.jpg" alt=""></img></a>
			</div>
			<div class="mainmenu">
				<ul class="menu">
					<ul>
			...
			<div class="about">
				...
				<div class="right_side">
					<h2>All Courses For Third Year Students is Here...!!!</h2>
					<br>
					<h3><a href="third_year.php?third_year_first_semester=Third Year First Semester">Third Year First Semester</a></h3>
					<br>
					<h3><a href="third_year.php?third_year_second_semester=Third Year Second Semester">Third Year Second Semester</a><h3>
					<br>
					<h3><a href="third_year.php?third_year_third_semester=Third Year Third Semester">Third Year Third Semester</a><h3>
					<br>
					
					<?php
						include("includes/db1.php");
						
						if(isset($_GET['third_year_first_semester']))
						{
							
					?>
					<table width="680" align="center" border="2">
						<tr>
							<td bgcolor="aqua" colspan="6" align="center"><h3>All courses for third year first semester is here...!!!</h3></td>
						</tr>
						<tr align="center">
							<th>Serial No.</th>
							<th>Subject Code</th>
						...
						<tr>
								<?php
									$subject = $_GET['third_year_first_semester'];
									
									$query = "select *from 3rd_year_1st_semester";
					...
					<?php
						...
						if(isset($_GET['third_year_second_semester']))
						{
							
					?>
					<table width="680" align="center" border="2">
						<tr>
							<td bgcolor="aqua" colspan="6" align="center"><h3>All courses for third year second semester is here...!!!</h3></td>
						</tr>
						<tr align="center">
							<th>Serial No.</th>
							<th>Subject Code</th>
						...
						<tr>
								<?php
									$subject1 = $_GET['third_year_second_semester'];
									
									$query1 = "select *from 3rd_year_2nd_semester";
					...
					<?php
						...
						if(isset($_GET['third_year_third_semester']))
						{
							
					?>
					<table width="680" align="center" border="2">
						<tr>
							<td bgcolor="aqua" colspan="6" align="center"><h3>All courses for third year third semester is here...!!!</h3></td>
						</tr>
						<tr align="center">
							<th>Serial No.</th>
							<th>Subject Code</th>
						...
						<tr>
								<?php
									$subject2 = $_GET['third_year_third_semester'];
									
									$query2 = "select *from 3rd_year_3rd_semester";
