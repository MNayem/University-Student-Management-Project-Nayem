	...
	<body onload="startTime()">
		...
		<div class="main">
			<div class="banner">
					...
					<a href="ptoto_gallery.php"><img src="images/NWU.jpg" alt=""></img></a>
			</div>
			<div class="mainmenu">
				<ul class="menu">
					<ul>
			...
			<div class="about">
				<div class="right_side1">
					<div class="photo">
						<div class="top">
						<br>
					<h3><p>freshers reception party</p></h3>
						<a href="freshers_reception.php"><img src="images/slider2.jpg"></img></a>
				</div>
				<div class="top1">
				<br>
					<h3><p>programming contest</p></h3>
						<a href="programming_contest.php"><img src="images/programming1.jpg"></img></a>
				</div>
				<div class="top2">
				<br>
					<h3><p>abroad seminar</p></h3>
						<a href="abroad_seminar.php"><img src="images/slider1.jpg"></img></a>
				</div>
				<div class="top3">
				<br>
					<h3><p>sports & tournament</p></h3>
						<a href="sports_and_tournament.php"><img src="images/football.jpg"></img></a>
				</div>	
				</div>
			</div>
		 </div>
