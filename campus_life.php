...
<html>
	<head>
		...
		<title>campus life for CSE student</title>
	</head>
	<body onload="startTime()">
		...
		<div class="main">
			<div class="banner">
					...
					<a href="campus_life.php"><img src="images/NWU.jpg" alt=""></img></a>
			</div>
			<div class="mainmenu">
				<ul class="menu">
					<ul>
			...
			<div class="about">
				...
				<div class="right_side">
					<h2>Campus Life For CSE Student of NWU</h2>
					<br>
					<p>Where to taste new dishes, eat till you drop, or meet your friends around a table. 
					   A wide choice of food is available in NWU canteens with traditional main courses, 
					   side dishes, drinks, desserts, tea or coffee. There are also dispensers of sandwiches, 
					   beverages and snacks at reasonable prices. 
					   Canteens Location & Opening Times >> Building 1 Location: 6th Floor Operating Time: 8.00 AM - 5.00 PM 
					   (All academic calender days except sunday) >>Building 2 Location: 9th Floor Operating
					   Time: 8.00 AM - 7.00 PM (All academic calender days except sunday)</p>
					<br>
				</div>
			</div>
		</div>
