...
<html>
	<head>
		...
		<title>contact with CSE department of NWU </title>
	</head>
	<body onload="startTime()">
		...
		<div class="main">
			<div class="banner">
					...
					<a href="contact.php"><img src="images/NWU.jpg" alt=""></img></a>
			</div>
			<div class="mainmenu">
				<ul class="menu">
					<ul>
			...
			<div class="about">
				...
				<div class="right_side">
					<h2>Contact us with for any kind of information</h2>
					<br><br>
					<p><b>
						01. Dean : <br></b><a href="">Email: dean@gmail.com;</a> <br><a href="">contact: +0472222</a>
					</p>
					<br>
					<p><b>
						02. Register : <br></b><a href="">Email: register@gmail.com;</a> <br><a href="">contact: +0472223</a>
					</p>
					<br>
                    <p><b>
						03. Head of Department : <br></b><a href="">Email: depthead@gmail.com;</a> <br><a href="">contact: +0472224</a>
					</p>
					<br>
				    <p><b>
						04. Exam Controller : <br></b><a href="">Email: xmcontroller@gmail.com;</a> <br><a href="">contact: +0472225</a>
					</p>
					<br>
					<p><b>
						05. Reception : <br></b><a href="">Email: reception@gmail.com;</a> <br><a href="">contact: +0472226</a>
					</p>
					<br><br>
				</div>
			</div>
